...
SITE_FINGERPRINTS = {
    ...
    "siliconbased": {
        "keywords": [
            "css framework", "api", "json formatter", "regex", "cron generator",
            "git", "docker", "hosting", "ssl", "dns", "http status",
            "developer tool", "dev tool", "code editor", "ide",
            "javascript", "python", "html", "css", "typescript",
            "framework", "library", "npm", "webpack", "vite",
            "favicon", "sitemap", "robots.txt", "seo tool",
            "chmod", "linux command", "terminal", "shell",
            "color picker", "hex", "rgb", "base64", "url encode",
            "markdown", "yaml", "csv", "xml",
        ],
        "negative": ["gaming", "recipe", "medical", "stock", "dividend"],
    },
    "leeroyjenkins": {
        "keywords": [
    ...
    "migratingmammals": {
        "keywords": [
            "digital nomad", "nomad visa", "cost of living", "expat",
            "travel insurance", "travel credit card", "best city",
            "coworking", "remote work abroad", "visa requirements",
            "airport", "flight", "backpack", "luggage", "packing",
            "time zone", "currency convert", "international",
            "thailand", "bali", "portugal", "mexico", "colombia",
            "long term stay", "apartment rental", "coliving",
        ],
    ...
    "sendnerds": {
        "keywords": [
            ...
            "study", "citation", "word counter", "reading level",
            "scholarship", "college", "university", "school",
            "test score", "exam", "quiz", "homework", "essay",
            "apush", "ap exam", "math problem", "statistics",
            "average calculator", "percentage calculator", "fraction",
    ...
    "justonemoment": {
        "keywords": [
            ...
            "alarm", "clock", "time", "minute timer", "hour timer",
            "tabata", "hiit timer",
        ],
        "negative": ["gaming", "recipe", "stock", "medical", "calculator"],
    },
    "nookienook": {
        "keywords": [
            "birth control", "condom", "sti", "std", "sexual health",
            "reproductive health", "fertility", "menstrual", "period",
            "pelvic floor", "sexual wellness", "lubricant", "libido",
            "orgasm", "intimacy", "contracepti", "hpv", "herpes",
            "pregnancy test", "ovulation", "bra size", "cup size",
        ],
        "negative": ["gaming", "recipe", "stock", "car "],
    },
    "papyruspeople": {
        "keywords": [
